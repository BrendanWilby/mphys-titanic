...
def load_contrast_data(name,epoch,method):
...
def save_data(name,epoch,method, rad_mass):
...
if __name__ == "__main__":
    ...
    for i in range(0,len(name_data)):                   #loop over all stars in file outputing data for each star
        ...
        contrast_curve = load_contrast_data(name_data[i,0],name_data[i,1],method)
        ...
        save_data(name_data[i,0],name_data[i,1],method,rad_mass)#saves all relavent data
